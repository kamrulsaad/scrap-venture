      ...
      <div className="px-[20px] md:px-[5%] lg:px-[10%] max-w-screen-2xl mx-auto text-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="bg-background text-foreground p-6 rounded-xl shadow-sm hover:shadow-md transition">
            <Image src="/assets/Icons/value.png" alt="Best Value" width={50} height={50} className="mx-auto mb-3" />
          ...
          {/* Card 2 */}
          <div className="bg-background text-foreground p-6 rounded-xl shadow-sm hover:shadow-md transition">
            <Image src="/assets/Icons/easy.png" alt="Convenience" width={50} height={50} className="mx-auto mb-3" />
          ...
          {/* Card 3 */}
          <div className="bg-background text-foreground p-6 rounded-xl shadow-sm hover:shadow-md transition">
            <Image src="/assets/Icons/trust.png" alt="Trust" width={50} height={50} className="mx-auto mb-3" />
          ...
          {/* Card 4 */}
          <div className="bg-background text-foreground p-6 rounded-xl shadow-sm hover:shadow-md transition">
            <Image src="/assets/Icons/eco.png" alt="Eco-friendly" width={50} height={50} className="mx-auto mb-3" />
