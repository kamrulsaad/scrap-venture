...
export default function Hero() {
  return (
    <section className="bg-muted py-10 md:py-20 h-[calc(100vh-100px)]">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 px-[20px] md:px-[5%] lg:px-[10%] max-w-screen-2xl mx-auto">
        {/* Left Text + Graphic */}
